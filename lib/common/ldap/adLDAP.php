...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@YOURDOMAIN.local";
    ...
    * @var string
    */
	protected $_base_dn = "OU=SBSUsers,OU=Users,OU=MyBusiness,DC=YOURDOMAIN,DC=local"; 
    ...
    * @var array
    */
    protected $_domain_controllers = array ("DNS_OR_IP_OF_DOMAIN_CONTROLLER");
